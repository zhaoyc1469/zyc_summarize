...
public class UIHelper {
    ...
    public static int dipToPx(float dip) {
        return (int) (dip * AppManager.getAppManager().getApp().getResources().getDisplayMetrics().density + 0.5f);
    }
    ...
    public static int pxToDip(float pxValue) {
        final float scale = AppManager.getAppManager().getApp().getResources().getDisplayMetrics().density;
    ...
    public static int sp2px(float spValue) {
        final float fontScale = AppManager.getAppManager().getApp().getResources().getDisplayMetrics().scaledDensity;
    ...
    public static int getScreenWidthPix(@Nullable Context context) {
        if (context == null) context = AppManager.getAppManager().getApp();
    ...
    public static void ToastMessage(String msg) {
        Toast.makeText(AppManager.getAppManager().getApp(), msg, Toast.LENGTH_LONG).show();
    }
    ...
    public static int getColor(int colorResId) {
        try {
            return AppManager.getAppManager().getApp().getResources().getColor(colorResId);
        } catch (Exception e) {
