...
public class InstallUtils {
    ...
    public void startDownload() {
        ...
        if (TextUtils.isEmpty(filePath)) {
            filePath = DownApkUtils.getCachePath(mContext) + "/update.apk";
        }
        //文件权限处理
        DownApkUtils.changeApkFileMode(new File(filePath));
        //下载
    ...
    public static void installAPK(Activity context, String filePath, final InstallCallBack callBack) {
        try {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                ...
                apkUri = DownUpdateApkFileProvider.getUriForFile(context, authority, apkFile);
            } else {
